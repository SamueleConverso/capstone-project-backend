...
namespace Capstone_Project.DTOs.Feed.Post
{
    public class PostDto
    {
        ...
        public ICollection<Post_PostLikeDto> PostLikes
        {
            get; set;
        }

        public ICollection<Post_CommentDto> Comments
        {
            get; set;
        }

        public ICollection<Post_PostTagDto> PostTags
        {
            get; set;
        }

        public Post_ApplicationUserDto? ApplicationUser
        {
            get; set;
        }

        public Post_VideogameDto? Videogame
        {
            get; set;
        }

        public Post_CommunityDto? Community { get; set; }
    }
}
